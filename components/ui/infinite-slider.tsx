...
export function InfiniteSlider({ 
  ...
  // Backwards compatibility if passing speed instead of duration
  const actualDuration = speed || duration;
  const actualHoverDuration = speedOnHover || durationOnHover;
  ...
  const hoverProps = actualHoverDuration ? {
    onHoverStart: () => { setIsTransitioning(true); setCurrentDuration(actualHoverDuration); },
